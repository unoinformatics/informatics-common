...
public class SimpleFeaturePojo extends EntityPojo implements SimpleFeature {
    ...
    public SimpleFeaturePojo(String uniqueIdentifier, String name, String description, DataType dataType,
            ScaleType scaleType) {
    ...
    public SimpleFeaturePojo(String name, DataType dataType, ScaleType scaleType, Number minimumValue,
            Number maximumValue) {
        super(name);
    ...
    public SimpleFeaturePojo(String uniqueIdentifier, String name, String description, DataType dataType,
            ScaleType scaleType, Number minimumValue, Number maximumValue) {
        super(uniqueIdentifier, name, description);
    ...
    private Method createMethod(String name, DataType dataType, ScaleType scaleType, Number minimumValue,
            Number maximumValue) {
