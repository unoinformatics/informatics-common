...
public class ArrayFeatureDataset extends AbstractFeatureDataset
{
      ...
      List<? extends Feature> features, Object[][] values)
  {
	...
	public ArrayFeatureDataset(Entity identification,
	    List<? extends Feature> features, Object[][] values) 
	{
	...
	public ArrayFeatureDataset(String name, List<? extends Feature> features, Object[][] values, Feature rowHeaderFeature)
  {
	  super(name, features);
      ...
      List<? extends Feature> features, Object[][] values, Feature rowHeaderFeature)
  {
	...
	public ArrayFeatureDataset(String name, List<? extends Feature> features, Object[] headers, Object[][] values, Feature rowHeaderFeature)
  {
    super(name, features);
  ...
  public ArrayFeatureDataset(String uniqueIdentifier, String name,
      List<? extends Feature> features, Object[] headers, Object[][] values, Feature rowHeaderFeature) 
  {
    super(uniqueIdentifier, name, features);
  ...
  public ArrayFeatureDataset(String name, List<? extends Feature> features, Object[] headers, String[] rowNames, Object[][] values, Feature rowHeaderFeature)
  {
    super(name, features);
  ...
  public ArrayFeatureDataset(String uniqueIdentifier, String name,
      List<? extends Feature> features, Object[] headers, String[] rowNames, Object[][] values, Feature rowHeaderFeature) 
  {
    super(uniqueIdentifier, name, features);
  ...
  public ArrayFeatureDataset(String name,
  ...
  public ArrayFeatureDataset(String name,
      List<? extends Feature> features, List<Object> headers, List<List<Object>> values, Feature rowHeaderFeature)
  {
    super(name, features);
  ...
  public ArrayFeatureDataset(String name,
      List<? extends Feature> features, List<Object> headers, List<String> rowNames, List<List<Object>> values, Feature rowHeaderFeature)
  {
    super(name, features);
  ...
  public final void setRowHeaderFeature(Feature rowHeaderFeature)
  {
	...
	public static final FeatureDataset readFeatureDatasetFromTextFile(File file, FileType fileType) throws DatasetException
	{
		...
		try
		{
          ...
          if (cells.size() > 0)
          {
            ...
            if (NAME.equals(cells.get(0)))
            {
              ...
              if (cells.size() > 1 && ID.equals(cells.get(1)))
              {
                ...
                rowHeaderFeature = new FeaturePojo("Ids", new MethodPojo("Ids", new ScalePojo("Ids", DataType.STRING, ScaleType.NOMINAL))) ;     
              }
              else
              {
                columnCount = cells.size() - 1 ;
                
                rowHeaderFeature = new FeaturePojo("Names", new MethodPojo("Names", new ScalePojo("Names", DataType.STRING, ScaleType.NOMINAL))) ;
              }
            }
            else
            {
              ...
              if (reader.nextRow())
              {
                ...
                if (MIN.equals(rowName))
                {
                  ...
                  if (reader.nextRow())
                  {
                    ...
                    {         
                      addHeaders(rowHeaderFeature, rowName, rowHeaders, rowID, rowNames) ;
                      
                      newFeatures = createFeatures(columnNames, typeCells, minCells, new LinkedList<String>()) ;
                ...
                {
                  newFeatures = createFeatures(columnNames, typeCells, new LinkedList<String>(), new LinkedList<String>()) ;
	      ...
	      if (hasNames)
	        if (hasIDs)
	          return new ArrayFeatureDataset(file.getName(), file.getName(), createDescription(file), newFeatures, rowHeaders, rowNames, rowList, rowHeaderFeature) ;
	        else
	          return new ArrayFeatureDataset(file.getName(), file.getName(), createDescription(file), newFeatures, rowHeaders, rowList, rowHeaderFeature) ; 
	      else
	        return new ArrayFeatureDataset(file.getName(), file.getName(), createDescription(file), newFeatures, rowList, rowHeaderFeature) ;        
			}
  ...
  private static void addValues(List<List<Object>> rowList, List<String> cells, List<FeaturePojo> features, int[] types) throws ConversionException
  {
  ...
  private static void addHeaders(FeaturePojo rowHeaderFeature, String rowName, List<Object> rowHeaders, String rowId, List<String> rowNames)
  {
    if (rowName != null)
    {
      if (rowId != null)
      {
        rowHeaders.add(rowId) ;
        rowNames.add(rowName) ;
        
        if (rowHeaderFeature != null)
          updateRowHeaderScale(rowHeaderFeature, rowId) ;
      }
      else
      {
        ...
        if (rowHeaderFeature != null)
          updateRowHeaderScale(rowHeaderFeature, rowName) ;
      }
    }
  }
  ...
  private static List<FeaturePojo> createFeatures(List<String> columnNames, List<String> typeCells, List<String> minCells, List<String> maxCells) throws DatasetException
  {
    ...
    while (iterator1.hasNext())
      features.add(createFeaure(iterator1.next(), 
          iterator2.hasNext() ? iterator2.next() : null, 
              iterator3.hasNext() ? iterator3.next() : null, 
                  iterator4.hasNext() ? iterator4.next() : null));
  ...
  private static FeaturePojo createFeaure(String name, String type, String min, String max) throws DatasetException
  {
    try
    {
      ...
      DataType dataType = type != null && type.length() > 0 ? getDataTypeByAbbreviation(type.substring(1, 2)) : DataType.STRING ;
      ScaleType scaleType = type != null && type.length() > 1 ? getScaleTypeByAbbreviation(type.substring(0, 1)) : ScaleType.NOMINAL ;
  ...
  public static final FeatureDataset createSubsetFeatureDataset(String uniqueIdentifier, String name, String description, 
			FeatureDataset dataset, Set<Integer> indices) throws DatasetException
	{
	...
	public static final FeatureDataset createSubsetFeatureDataset(String uniqueIdentifier, String name, String description, 
			FeatureDataset dataset, int[] indices) throws DatasetException
	{
	 ...
	 * @param next
	 */
  private static void updateRowScales(List<FeaturePojo> features,
      List<Object> row)
  {
  ...
  private static void updateRowHeaderScale(FeaturePojo rowHeaderFeature, String header)
  {
  ...
  {
    if (ScaleType.NOMINAL.equals(scale.getScaleType()) || ScaleType.ORDINAL.equals(scale.getScaleType()) || ScaleType.INTERVAL.equals(scale.getScaleType())) 
    {
      scale.addValue(value) ;
    }
    
    if (ScaleType.ORDINAL.equals(scale.getScaleType()) || ScaleType.INTERVAL.equals(scale.getScaleType()) || ScaleType.RATIO.equals(scale.getScaleType())) 
    {
      if (value instanceof Number)
      {
        if (scale.getMinimumValue() == null || scale.getMinimumValue().doubleValue() > ((Number)value).doubleValue())
          scale.setMinimumValue((Number)value);
        
        if (scale.getMaximumValue() == null || scale.getMaximumValue().doubleValue() < ((Number)value).doubleValue())
  	...
  	if (values != null)
  	{
  		...
  		for (int i = 0 ; i < values.length ; ++i)
  		{
  			if (columnCount != values[i].length)
  				throw new IllegalArgumentException("Row : " + i + " size : " + values[i].length + " does not match the number of feaures : " + columnCount) ;
    ...
    if (values != null)
    {
      ...
      for (int i = 0 ; i < values.length ; ++i)
      {
        if (columnCount != values[i].length - 1)
          throw new IllegalArgumentException("Row : " + i + " size : " + (values[i].length - 1) + " does not match the number of feaures : " + columnCount) ;
   ...
   * @throws DatasetException 
   */
  private final void setValuesWithHeaders(Object[] headers, Object[][] values) throws IllegalArgumentException
  {
    rowCount = 0 ;
   ...
   * @throws DatasetException 
   */
  private final void setValuesWithHeaders(Object[] headers, String[] rowNames, Object[][] values) throws IllegalArgumentException
  {
    rowCount = 0 ;
   ...
   * @param values
   */
  private final void setValuesWithHeaders(List<Object> headers, List<List<Object>> values)
  {
    rowCount = 0 ;
    ...
    if (values != null)
    {
      ...
      Iterator<Object> iterator2 = headers.iterator() ;
      
      int i = 0 ;
      
      while(iterator1.hasNext())
      {
        rows[i] = ArrayFeatureDatasetRow.createRow(iterator2.hasNext() ? iterator2.next() : null, iterator1.next()) ;
        ++i ;
      }
    }
  }
   ...
   * @param values
   */
  private final void setValuesWithHeaders(List<Object> headers, List<String> rowNames, List<List<Object>> values)
  {
    rowCount = 0 ;
    ...
    if (values != null)
    {
      ...
      Iterator<List<Object>> iterator1 = values.iterator() ;
      Iterator<Object> iterator2 = headers.iterator() ;
      Iterator<String> iterator3 = rowNames.iterator() ;
      
      int i = 0 ;
      
      while(iterator1.hasNext())
      {
        rows[i] = ArrayFeatureDatasetRow.createRow(iterator2.hasNext() ? iterator2.next() : null, iterator3.hasNext() ? iterator3.next() : null, iterator1.next()) ;
        ++i ;
      }
    }
  }
