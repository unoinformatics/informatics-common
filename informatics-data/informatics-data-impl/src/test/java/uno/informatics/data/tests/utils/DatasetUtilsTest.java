...
public class DatasetUtilsTest
{
	...
	/**
	 * Test method for {@link uno.informatics.data.utils.DatasetUtils#generateDatasetFeatures(uno.informatics.common.io.FileProperties, boolean, java.lang.String, int)}.
	 */
  @Test
		...
		try
    {
	    ...
	    List<ColumnFeature> expected = new ArrayList<ColumnFeature>() ;
			...
			assertFeaturesEquals(expected, DatasetUtils.generateDatasetFeatures(new FileProperties(this.getClass().getResource("/object_table.txt").getFile(), 0, 1), null, 3)) ;
    }
	...
	/**
	 * Test method for {@link uno.informatics.data.utils.DatasetUtils#getConversionType(uno.informatics.common.model.DataType)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link uno.informatics.data.utils.DatasetUtils#getConversionType(uno.informatics.common.model.Scale)}.
	 */
	@Test
	public void testGetConversionTypeScale()
	{
		...
		assertEquals(DataTypeConstants.BOOLEAN_ID, DatasetUtils.getConversionType(new ScalePojo("test", DataType.BOOLEAN, ScaleType.NOMINAL))) ;
		assertEquals(DataTypeConstants.SHORT_ID, DatasetUtils.getConversionType(new ScalePojo("test", DataType.SHORT, ScaleType.NOMINAL))) ;
		assertEquals(DataTypeConstants.INT_ID, DatasetUtils.getConversionType(new ScalePojo("test", DataType.INTEGER, ScaleType.NOMINAL))) ;
		assertEquals(DataTypeConstants.LONG_ID, DatasetUtils.getConversionType(new ScalePojo("test", DataType.LONG, ScaleType.NOMINAL))) ;
		assertEquals(DataTypeConstants.FLOAT_ID, DatasetUtils.getConversionType(new ScalePojo("test", DataType.FLOAT, ScaleType.NOMINAL))) ;
		assertEquals(DataTypeConstants.DOUBLE_ID, DatasetUtils.getConversionType(new ScalePojo("test", DataType.DOUBLE, ScaleType.NOMINAL))) ;
		assertEquals(DataTypeConstants.BIG_INTEGER_ID, DatasetUtils.getConversionType(new ScalePojo("test", DataType.BIG_INTEGER, ScaleType.NOMINAL))) ;
		assertEquals(DataTypeConstants.BIG_DECIMAL_ID, DatasetUtils.getConversionType(new ScalePojo("test", DataType.BIG_DECIMAL, ScaleType.NOMINAL))) ;
		assertEquals(DataTypeConstants.DATE_ID, DatasetUtils.getConversionType(new ScalePojo("test", DataType.DATE, ScaleType.NOMINAL))) ;
		assertEquals(DataTypeConstants.STRING_ID, DatasetUtils.getConversionType(new ScalePojo("test", DataType.STRING, ScaleType.NOMINAL))) ;
	}

	/**
	 * Test method for {@link uno.informatics.data.utils.DatasetUtils#getConversionTypes(uno.informatics.common.model.DataType[])}.
	 */
	@Test
	public void testGetConversionTypesDataTypeArray()
	{
		...
		assertEquals(DataTypeConstants.NUMBER_IDS, DatasetUtils.getConversionTypes(
				DataType.SHORT, DataType.INTEGER, DataType.LONG, DataType.FLOAT, DataType.DOUBLE, DataType.BIG_INTEGER, DataType.BIG_DECIMAL)) ;
		assertEquals(DataTypeConstants.INTEGER_IDS, DatasetUtils.getConversionTypes(
				DataType.SHORT, DataType.INTEGER, DataType.LONG, DataType.BIG_INTEGER)) ;
		assertEquals(DataTypeConstants.REAL_IDS, DatasetUtils.getConversionTypes(
				DataType.FLOAT, DataType.DOUBLE, DataType.BIG_DECIMAL)) ;
	}

	/**
	 * Test method for {@link uno.informatics.data.utils.DatasetUtils#getConversionTypes(java.util.List)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link uno.informatics.data.utils.DatasetUtils#getConversionTypes(uno.informatics.common.model.Feature, java.util.List)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link uno.informatics.data.utils.DatasetUtils#getDataTypes(int)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link uno.informatics.data.utils.DatasetUtils#getScaleTypes(uno.informatics.common.model.DataType)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link uno.informatics.data.utils.DatasetUtils#copyFeature(uno.informatics.common.model.Feature)}.
	 */
	@Test
	 ...
	 */
  private void assertFeaturesEquals(List<ColumnFeature> expected,
      List<ColumnFeature> actual)
  {
