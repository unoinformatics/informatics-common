...
public class TestData
{
	...
	protected final static String[] STRING_ROW3 = new String[] {"R3C1","R3C2","R3C3"} ;
        protected final static String[] STRING_ROW2_WITH_GAPS = new String[] {"R2C1",null,"R2C3"} ;
        protected final static String[] STRING_ROW3_WITH_GAPS = new String[] {"R3C1","R3C2",null} ;
        
	protected final static String[][] STRING_TABLE_AS_ARRAY = new String[][] {STRING_ROW1, STRING_ROW2, STRING_ROW3} ;
	
	protected final static String[][] STRING_TABLE_AS_ARRAY_WITH_GAPS = new String[][] {STRING_ROW1, STRING_ROW2_WITH_GAPS, STRING_ROW3_WITH_GAPS} ;
  ...
  protected final static Object[] OBJECT_ROW3 = new Object[] {3,3.3,"R3C3", true, new Date("14/12/2012")} ;
	...
	protected final static Object[][] OBJECT_TABLE_AS_ARRAY_WITH_GAPS = new Object[][] {OBJECT_ROW1, OBJECT_ROW2, OBJECT_ROW3} ;
