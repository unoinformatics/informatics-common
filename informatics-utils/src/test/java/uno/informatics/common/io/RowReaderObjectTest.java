...
public abstract class RowReaderObjectTest extends RowReaderTest {
     ...
     * 
     */
    private void testNextInt(TableReader reader, int rowIndex, int columnIndex, int expected)
        throws IOException {
        if (reader.hasNextColumn()) {
            assertTrue("Can not get next column at row index" + rowIndex + " column index " + columnIndex,
                reader.nextColumn());

            assertEquals("cell not equal at row index" + rowIndex + " column index " + columnIndex, expected,
                reader.getCell());
     ...
     * 
     */
    private void testNextDouble(TableReader reader, int rowIndex, int columnIndex, double expected)
        throws IOException {
        if (reader.hasNextColumn()) {
            assertTrue("Can not get next column at row index" + rowIndex + " column index " + columnIndex,
                reader.nextColumn());
     ...
     * 
     */
    private void testNextString(TableReader reader, int rowIndex, int columnIndex, String expected)
        throws IOException {
        if (reader.hasNextColumn()) {
            assertTrue("Can not get next column at row index" + rowIndex + " column index " + columnIndex,
                reader.nextColumn());
     ...
     * 
     */
    private void testNextBoolean(TableReader reader, int rowIndex, int columnIndex, boolean expected)
        throws IOException {
        if (reader.hasNextColumn()) {
            assertTrue("Can not get next column at row index" + rowIndex + " column index " + columnIndex,
                reader.nextColumn());
     ...
     * 
     */
    private void testNextObject(TableReader reader, int rowIndex, int columnIndex, Object expected)
        throws IOException {
        if (reader.hasNextColumn()) {
            assertTrue("Can not get next column at row index" + rowIndex + " column index " + columnIndex,
                reader.nextColumn());
