...
public abstract class TableReaderTest extends TestData
{
		...
		try
    {
	    ...
	    while (reader.hasNextRow())
	    {
		    ...
		    while (reader.hasNextColumn())
		    {
		    	...
		    	assertEquals("cell not equal at row index" + rowIndex + " column index " + columnIndex, expected[rowIndex][columnIndex], reader.getCell()) ;
