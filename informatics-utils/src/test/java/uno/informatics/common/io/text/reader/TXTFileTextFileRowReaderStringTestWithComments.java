...
public class TXTFileTextFileRowReaderStringTestWithComments extends RowReaderStringTest {
    private static final String FILE = "/string_table_with_comments.txt";
