...
public abstract class RowReaderBooleanTest extends RowReadWriteTest {
    ...
    protected final static boolean[] ROW2 = new boolean[] {
        false, true, false
    };
    protected final static boolean[] ROW3 = new boolean[] {
        true, false, false
    };

    protected final static boolean[] ROW2_WITH_GAPS = new boolean[] {
        false, false, false
    };
    protected final static boolean[] ROW3_WITH_GAPS = new boolean[] {
        true, false, false
    };
     ...
     */
    private void assertArrayEquals(String message, boolean[] expected, boolean[] actual) {
