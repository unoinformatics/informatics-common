...
public class CSVFileTextFileRowReaderStringTestWithEmptyLines extends RowReaderStringTest {
    private static final String FILE = "/string_table_with_empty_lines.csv";
