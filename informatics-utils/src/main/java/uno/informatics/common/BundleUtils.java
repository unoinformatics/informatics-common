...
public class BundleUtils {
     ...
     */
    public static List<String> getStringList(ResourceBundle resourceBundle, String key) {
     ...
     * @return the required string list
     */
    public static List<String> getStringList(ResourceBundle resourceBundle, String key, String[] parameters) {
        List<String> list = new LinkedList<String>();
     ...
     * @return the required string list
     */
    public static List<String> getStringList(ResourceBundle resourceBundle, String key, int[] parameters) {
        List<String> list = new LinkedList<String>();
